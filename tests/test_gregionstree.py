...
class TestGRegionsTree(unittest.TestCase):
    ...
    def test_len(self):
        regions = GRegions(name="test", implementation="tree")
    ...
    def test_extend(self):
        ...
        self.assertEqual(regions.extend(upstream=100, strandness=True, inplace=False)[0].start, 700)
        self.assertEqual(regions.extend(downstream=100, strandness=True, inplace=False)[0].start, 800)
    ...
    def test_intersect(self):
        regions1 = GRegions(name="test", implementation="tree")
    ...
    def test_sampling(self):
        regions = GRegions(load=os.path.join(script_path, "test_files/bed/example4.bed"), implementation="tree")
